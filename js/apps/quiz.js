document.addEventListener('DOMContentLoaded', function() {
    // Alle DOM-Elemente, auf die wir zugreifen möchten
    ...
    if (formRoom) {
        formRoom.addEventListener('submit', changeRoom);
    }
        ...
        if (answerDisplay) {
            ...
            data.forEach(answer => {
                ...
                answerElement.addEventListener('click', (event) => {
                    ...
                    console.log('Antwort-ID:', playerAnswer, 'Frage-ID:', question_id);
    ...
    // Ausgewertete Antworten empfangen
